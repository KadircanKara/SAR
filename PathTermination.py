from pymoo.termination.default import MultiObjectiveSpaceTermination, Termination, DefaultMultiObjectiveTermination, MaximumGenerationTermination, MaximumFunctionCallTermination
...
class PathDefaultTermination(PathTermination):
    ...
    def __init__(self, x, cv, f, n_max_gen=3000, n_max_evals=300000) -> None:
        super().__init__()
        self.x = x
        self.cv = cv
        self.f = f
...
"""termination = MultiObjectiveSpaceTermination(
    ...
    # n_max_gen=3000,      # Maximum number of generations (acts as a safety net)
    # n_max_evals=1000000  # Maximum number of evaluations
)
